...
<head>
  ...
  <link rel="icon" href="protection.png"/>
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="aksi.php?act=logout" onclick="return confirm('Apakah anda yakin ingin keluar ?')"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>                   
            </ul>          
        </div>
    </div>
</nav>
...
<footer class="footer bg-primary">
  <div class="container">
    <p>Copyright &copy; <?=date('Y')?> Rachmat Pirdaus <em class="pull-right">COVID-19 -06 Nov 2020- </em></p>
  </div>
</footer>
</body>
</html>